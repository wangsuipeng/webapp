...
export default {
    ...
    created () {
        this.postForm.content = this.$store.getters.articleContent;
        this.postForm.title = this.$store.getters.articleTitle;
    },
    mounted() {
        // if (window.plus) {
    ...
    methods: {
        ...
        editPostingMsg() {
            this.$axios({
                url: "admin/mobile/article/updateArticle",
                method: "post",
                headers: {
