            ...
            <mu-list>
              ...
              <div v-for="(item,index) in releaseLove" :key="index">
                <mu-list-item
                  ...
                  button
                  v-ripple
                  @click.native="submitAudit(item.serviceId)"
                  class="muse-list"
                >
            ...
            <mu-list textline="three-line">
              ...
              <div v-for="(item,index) in allunReviewTask" :key="item.serviceId">
                <mu-list-item
                  ...
                  v-ripple
                  button
                  @click.native="auditProgress(item.serviceId)"
                  class="muse-list"
                >
                  <mu-list-item-action>
                    <mu-avatar>
                  ...
                  <mu-list-item-content>
                    <mu-list-item-title
                      style="font-size: 16px;font-weight: 600;color: #030303;margin-bottom: 10px"
                    >{{item.serviceName}}</mu-list-item-title>
                    <mu-list-item-sub-title>
                      <div style="color: #ff5242;display: inline-block">爱心币 {{item.points}}/次</div>
                    </mu-list-item-sub-title>
                  </mu-list-item-content>
                </mu-list-item>
              </div>
              ...
              <div v-for="(item,index) in queryAllSubmitData" :key="index">
                <mu-list-item
                  ...
                  v-ripple
                  button
                  @click.native="auditContents(item.serviceId)"
                  class="muse-list"
                >
                  <mu-list-item-action>
                    <mu-avatar>
