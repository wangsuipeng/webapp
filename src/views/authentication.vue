    ...
    <div class="container-main">
      <table width="100%" border="1" align="center">
        <tr>
          ...
          <td align="center">{{authenticationData.communityName}}</td>
        </tr>
        <tr>
          <td align="center">真实姓名</td>
          <td align="center">{{authenticationData.realName}}</td>
        </tr>
        <tr>
          <td align="center">角色类型</td>
          <td align="center">{{authenticationData.roleType}}</td>
        </tr>
        <tr>
          <td align="center">电话号码</td>
          <td align="center">{{authenticationData.userPhone}}</td>
        </tr>
        <tr>
          <td align="center">家庭住址</td>
          <td align="center">{{authenticationData.address}}</td>
        </tr>
        <tr>
          <td align="center">认证状态</td>
          <td align="center">{{authenticationData.check}}</td>
        </tr>
        <tr>
          <td align="center">认证时间</td>
          <td align="center">{{authenticationData.checkTime}}</td>
        </tr>
      </table>
      ...
      this.$axios({
        ...
        .then(result => {
          if (result.data.respCode == 1000) {
            ...
            this.authenticationData.communityName =
              result.data.data.communityName;
